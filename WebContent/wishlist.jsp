...
<%
	...
	List<WishList> elements = wishlistService.getExistedWishList(user.getId());
...
<title>The Book Store - My Wish List</title>
...
<div class="container">
	...
	<form id="listForm" action="control"   method="get">
	...
	<div class="row" style="padding-top: 40px">
        <div class="col-md-6 col-md-offset-3" align="center">
                <button id="clearWishList" class="btn btn-link" type="submit" name="action" value="rmwishlist"><span class="glyphicon glyphicon glyphicon-trash"></span>Remove </button>
                <button id="checkoutWishList" class="btn btn-link" type="submit" name="action" value="wltocart"><span class="glyphicon glyphicon-credit-card"></span>Add to Cart </button>
		</div>
	</div>
